import {  NavController, Tabs, App, MenuController, AlertController, LoadingController} from 'ionic-angular';
//, , Loading, Alert
//import {AccountData} from '../../providers/account-data';IONIC_DIRECTIVES,IonicApp,
import {Component, OnInit, AfterViewInit} from '@angular/core';//,AfterViewInit

import {AccountService} from '../../../services/index';
import {ShareAccount, CurrentPage} from '../index';
...
export class AccountsPage  implements OnInit, AfterViewInit{
...
//private app: IonicApp,
  constructor(public tabs:Tabs, public nav : NavController ,public app: App,
   public _accountService: AccountService, public menu: MenuController, 
